...
/* =============================================================================
   ...
   ============================================================================= */
/* (AZURE SQL) La base AurisDB se crea desde el Portal de Azure al crear el
   recurso "SQL Database". Azure SQL NO soporta CREATE DATABASE en script ni USE
   (cada conexion va directo a una base). => Conectate a la base AurisDB y
   ejecuta este archivo. (En SQL Server normal usa AurisDB_INSTALL.sql.) */
